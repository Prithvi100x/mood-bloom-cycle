    ...
    <div className="min-h-screen bg-background pb-20">
      <div className="container px-4 py-6 max-w-md mx-auto">
        <header className="mb-6">
          <h1 className="text-2xl font-bold text-foreground">MoodBloom</h1>
        ...
        <ScrollArea className="h-[calc(100vh-10rem)]">
          <div className="space-y-6">
            <Card className="overflow-hidden">
              <CardHeader className="bg-gradient-to-r from-bloom-300 to-lavender-300 text-white pb-8">
                <CardTitle className="text-xl">Daily Check-in</CardTitle>
                <CardDescription className="text-white text-opacity-90">
                  How are you feeling today?
                </CardDescription>
              </CardHeader>
              <CardContent className="-mt-6 rounded-t-3xl bg-background pt-6">
                <MoodSelector 
